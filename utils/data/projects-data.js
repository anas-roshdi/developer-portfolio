export const projectsData = [
    {
      ...
      description: "Developed a professional desktop application for accounting and inventory management. The system features a dynamic invoicing module for sales and purchases, integrated with a local SQLite database. It includes automated financial reporting and data export capabilities to Excel using Pandas.",
      tools: ['Python', 'Tkinter', 'SQLite', 'Pandas', 'Git'],
